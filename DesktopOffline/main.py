...
.foot-copy{display:flex;flex-direction:column;gap:5px}
.foot-contact{color:#5a738e;font-size:11.5px;font-weight:500}
...
<div style="max-width:1180px;margin:auto;padding:28px;min-height:100vh">
  ...
  <div class="foot">
    <div class="foot-copy">
      <div>Phát triển bởi: <strong>Nguyễn Khắc Tú - Viện KSND khu vực 5 - Bắc Ninh</strong></div>
      <div class="foot-contact">Liên hệ báo lỗi, góp ý hoàn thiện Bộ công cụ qua email: nguyenkhactu.hlu@gmail.com</div>
    </div>
