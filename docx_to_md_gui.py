...
# ============================================================
# IMPORT ENGINE TỪ Docx_to_md
# ============================================================
sys.path.insert(0, os.path.join(os.path.dirname(__file__), 'Docx_to_md'))

try:
    from Docx_to_md.convert_doc_to_md import (
        read_docx_text,
    ...
    print("[WARNING] Không thể import Docx_to_md.convert_doc_to_md. Dùng engine dự phòng.")
...
def browse_folder():
    ...
    try:
        ...
        folder = filedialog.askdirectory(title='Chọn thư mục cha chứa file Word')
        root.destroy()
        if folder:
