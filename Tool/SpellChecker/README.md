...
Ứng dụng rà lỗi trong tệp `.docx`, chạy hoàn toàn trên máy người dùng. Không AI, không API và không gửi tài liệu ra Internet.
...
Đầu ra: `dist/RaSoatChinhTa.exe`. Máy người dùng không cần cài Python, Flask, Microsoft Word hay thư viện nào khác.
